...
, 			{
				"box" : 				{
					...
					"presentation_rect" : [ 319.0, 864.0, 0.0, 0.0 ],
					"text" : "pvar ioiReps"
				}
...
, 			{
				"box" : 				{
					...
					"presentation_rect" : [ 219.0, 864.0, 0.0, 0.0 ],
					"text" : "pvar baseReps"
				}
...
, 			{
				"box" : 				{
					...
					"presentation_rect" : [ 720.0, 724.0, 0.0, 0.0 ],
					"text" : "pvar ioiReps"
				}
...
, 			{
				"box" : 				{
					...
					"presentation_rect" : [ 620.0, 724.0, 0.0, 0.0 ],
					"text" : "pvar baseReps"
				}
...
, 			{
				"box" : 				{
					...
					"presentation_rect" : [ 299.0, -1.0, 0.0, 0.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"presentation_rect" : [ 181.0, 593.0, 0.0, 0.0 ],
...
, 			{
				"box" : 				{
					...
					"presentation_rect" : [ 743.0, 666.0, 0.0, 0.0 ],
					"text" : "prepend 1"
				}
...
, 			{
				"box" : 				{
					...
					"presentation_rect" : [ 119.0, 557.0, 0.0, 0.0 ],
					"saved_object_attributes" : 					{
						"embed" : 0
					}
,
...
, 			{
				"box" : 				{
					...
					"presentation_rect" : [ 665.0, 609.0, 0.0, 0.0 ],
					"text" : "pvar rests"
				}
...
, 			{
				"box" : 				{
					...
					"presentation_rect" : [ 821.0, 181.0, 0.0, 0.0 ],
					"varname" : "rests"
				}
...
, 			{
				"box" : 				{
					...
					"presentation_rect" : [ 141.0, 212.0, 0.0, 0.0 ],
					"text" : "pvar baseReps"
				}
...
, 			{
				"box" : 				{
					...
					"presentation_rect" : [ 71.0, 156.0, 0.0, 0.0 ],
...
, 			{
				"box" : 				{
					...
					"presentation_rect" : [ 100.0, 297.0, 0.0, 0.0 ],
					"text" : "% 1."
				}
...
, 			{
				"box" : 				{
					...
					"presentation_rect" : [ 93.0, 368.0, 0.0, 0.0 ],
					"text" : "% 1."
				}
...
, 			{
				"box" : 				{
					...
					"presentation_rect" : [ 320.0, 472.0, 0.0, 0.0 ],
					"text" : "int"
				}
...
, 			{
				"box" : 				{
					...
					"presentation_rect" : [ 146.0, 527.0, 0.0, 0.0 ],
					"text" : "pvar ioiReps"
				}
...
, 			{
				"box" : 				{
					...
					"presentation_rect" : [ 253.0, 385.0, 0.0, 0.0 ],
					"text" : "pvar ioiReps"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"presentation_rect" : [ 601.0, 580.0, 0.0, 0.0 ],
									"saved_object_attributes" : 									{
										"embed" : 0
									}
,
...
, 							{
								"box" : 								{
									...
									"presentation_rect" : [ 430.0, 576.0, 0.0, 0.0 ],
									"saved_object_attributes" : 									{
										"embed" : 0
									}
,
...
, 							{
								"box" : 								{
									...
									"presentation_rect" : [ 514.0, 541.0, 0.0, 0.0 ],
									"text" : "nth 3 $1"
								}
...
, 							{
								"box" : 								{
									...
									"presentation_rect" : [ 519.0, 569.0, 0.0, 0.0 ]
								}
...
, 			{
				"box" : 				{
					...
					"presentation_rect" : [ 797.0, 40.0, 0.0, 0.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"presentation_rect" : [ 819.0, 130.0, 0.0, 0.0 ],
					"varname" : "ioiReps"
				}
...
, 			{
				"box" : 				{
					...
					"presentation_rect" : [ 721.0, 126.0, 0.0, 0.0 ],
					"varname" : "baseReps"
				}
...
, 			{
				"box" : 				{
					...
					"presentation_rect" : [ 659.0, 466.0, 0.0, 0.0 ],
...
, 			{
				"box" : 				{
					...
					"presentation_rect" : [ 445.0, 790.0, 0.0, 0.0 ],
					"text" : "pvar startingPoint"
				}
